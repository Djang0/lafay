...
public abstract class DAO<T> implements Deletable<T> {
	...
	/*
	 * public String getRelatedAncestor(T elemObj,Class ancestorClass, String
	 * field){ //TODO : continue not WORKING
	 * ds.find(ancestorClass).field(field).hasThisElement(elemObj); return
	 * g.getNom(); }
	 */
}
